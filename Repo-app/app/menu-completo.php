...
<html lang="es">
    <head>
        ...
        <title>Menú Completo - Umai Sushi</title>
    ...
    <!-- FIN header -->
        ...
        <section id="fondo-descubre">
                <div class="titulo-cartacompleta">
                    <h2>¡ La carta al completo !</h2>
                    <p class="txt-contenedores">Siempre a tu disposición</p>
                </div>
        </section>
    ...
    <!-- entrantes --> 
                ...
                <div class="categorias">
                    ...
                    <div class="dish">
                        <div class="dish-info">
                            <h4>Agedashi Tofu (Tofu frito en caldo dashi)</h4>
                            <p>Alérgenos: Puede contener trigo, soja, y sésamo.</p>
                        </div>
                        <div class="dish-image">
                    ...
                    <div class="dish">
                        <div class="dish-info">
                            <h4>Sunomono (Ensalada de pepino y mariscos)</h4>
                    ...
                    <div class="dish">
                        <div class="dish-info">
                            <h4>Okonomiyaki (Tortilla japonesa)</h4>
                            <p>Alérgenos: Puede contener trigo, soja, y sésamo.</p>
                        </div>
                        <div class="dish-image">
                    ...
                    <div class="dish">
                        <div class="dish-info">
                            <h4>Nasu Dengaku (berenjena asada con salsa de miso)</h4>
    ...
    <!-- platos calientes -->    
                ...
                <div class="categorias">
                    ...
                    <div class="dish">
                        <div class="dish-info">
                            <h4>Yakimeshi (Arroz frito japonés)</h4>
                    ...
                    <div class="dish">
                        <div class="dish-info">
                            <h4>Nabe (Olla caliente japonesa)</h4>
                    ...
                    <div class="dish">
                        <div class="dish-info">
                            <h4>Kushiyaki (brochetas de verduras a la parrilla)</h4>
    ...
    <!-- sushi -->         
                ...
                <div class="categorias">
                    ...
                    <div class="dish">
                        <div class="dish-info">
                            <h4>Tamago Sushi (Sushi de tortilla japonesa)</h4>
                    ...
                    <div class="dish">
                        <div class="dish-info">
                            <h4>Unagi Nigiri (Nigiri de anguila asada)</h4>
                    ...
                    <div class="dish">
                        <div class="dish-info">
                            <h4>Inari Sushi (Bolsitas de tofu frito rellenas de arroz)</h4>
                    ...
                    <div class="dish">
                        <div class="dish-info">
                            <h4>Kappa Maki (Maki de pepino)</h4>
                    ...
                    <div class="dish">
                        <div class="dish-info">
                            <h4>Ebi Nigiri (Nigiri de camarón)</h4>
                    ...
                    <div class="dish">
                        <div class="dish-info">
                            <h4>Hamachi Nigiri (Nigiri de pez limón)</h4>
    ...
    <!-- FIN sushi -->
            ...
            <div class="div-botonmenu">
                <a href="pagina-principal.php" class="boton-menu-completo">Página Principal</a>
            </div>
        </section>
